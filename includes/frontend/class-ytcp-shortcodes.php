...
class YTCP_Shortcodes {
    ...
    public function register() {
        add_shortcode('ytcp', [$this, 'render_full_page']);
        add_shortcode('ytcp_hero', [$this, 'render_hero']);
        add_shortcode('ytcp_playlist', [$this, 'render_playlist']);
        add_shortcode('ytcp_player', [$this, 'render_player']);
        add_shortcode('ytcp_search', [$this, 'render_search']);
    ...
    public function render_playlist($atts) {
        $atts = shortcode_atts(['id' => 0], $atts, 'ytcp_playlist');
    ...
    public function render_player($atts) {
        $atts = shortcode_atts(['video' => 0], $atts, 'ytcp_player');
