...
class YTCP {
	...
	/**
	 * Constructor — loads all class dependencies.
	 */
	...
	/**
	 * Loads all required class files and instantiates the loader.
	 *
	 * @return void
	 */
	...
	/**
	 * Registers all actions, filters, and sub-system hooks, then runs the loader.
	 *
	 * @return void
	 */
	public function run() {
	...
	/**
	 * Schedules the transcript background sync cron event if not already scheduled.
	 *
	 * @return void
	 */
	...
	/**
	 * Fires the transcript sync batch when the cron event triggers.
	 *
	 * @return void
	 */
	...
	/**
	 * Displays admin notices for API key, channel, and sync configuration state.
	 *
	 * @return void
	 */
