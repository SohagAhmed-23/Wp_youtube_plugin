...
if ( empty( $videos ) || empty( $playlist ) ) {
	return;
}

$direction      = ( 0 === $row_index % 2 ) ? 'ltr' : 'rtl';
$slider_id      = 'ytcp-slider-' . ( $playlist->ID ? $playlist->ID : sanitize_title( $playlist->post_title ) ) . '-' . $row_index;
